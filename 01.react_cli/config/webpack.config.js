...
module.exports = function (webpackEnv) {
  ...
  const getStyleLoaders = (cssOptions, preProcessor) => {
    const loaders = [
      // 如果是开发环境，就使用 style-loader; 生产环境使用 MiniCssExtractPlugin.loader
  ...
  return {
    ...
    // 当前是生产环境并且我需要使用 sourcemap，那么我的值就是 source-map
    ...
    plugins: [
      ...
      // 监视 node_modules， 一旦变化可以重启 dev server
      isEnvDevelopment &&
